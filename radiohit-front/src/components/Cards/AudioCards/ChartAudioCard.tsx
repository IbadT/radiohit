...
const ChartAudioCard = ({ song, index }) => {
  const {
    setSingleTrackData,
    singleTrackData,
    stopped,
  ...
  return (
    ...
    >
      ...
      >
        <p className="mr-[1rem] text-slate-500">#{index}</p>
        <div
          className={cn(
        ...
        <div className="flex flex-col">
          <p className="text-[#131414] min-[1200px]:max-[1400px]:text-[0.9rem] text-ellipsis  line-clamp-1 w-full">
            {song.trackSongName}
          </p>
          <Link
