...
import { MoveLeft, MoveRight, Video } from "lucide-react";
import Image from "next/image";
import CustomMdx from "@/components/CustomMDX/CustomMdx";
import ClipsVideoCard from "@/components/Pages/ClipsDetailsPage/ClipsVideoCard";
import ScrollToTop from "@/components/ui/ScrollToTop/ScrollToTop";

const ClipsDetailsPage = ({ singleClip, nextPost, prevPost }) => {
  const createdDate = new Date(singleClip.$createdAt).toLocaleDateString(
    "ru-RU"
  );
    ...
    <>
      ...
      <div className="lg:pl-[1.5rem] lg:pt-[1.6rem] mb-[1.8rem] max-[1200px]:mx-[1rem] max-[1200px]:!pl-[0]">
        <div className="flex flex-col bg-white border-[1px] border-mainBorderColor rounded-3xl p-[1rem] h-auto">
          {/*Image with text*/}
          <div className="relative w-full h-[22vw] max-xl:h-[24rem] max-md:h-[16rem] overflow-hidden rounded-2xl group bg-gray-200 max-md:hidden">
          ...
          <div className="relative px-[2.5rem] z-[3] top-[-5rem] max-md:top-0 h-auto max-md:px-0">
            <div className="bg-white rounded-2xl p-[2rem] max-w-[800px] mx-auto max-md:px-[0.5rem] max-md:pt-[1.2rem] max-md:pb-0">
              <div className="flex flex-col">
                ...
                <div className="w-full rounded-2xl overflow-hidden h-[30rem] mb-[1rem] max-md:h-[10rem] min-[1400px]:max-[1600px]:h-[20rem] min-[1300px]:max-[1400px]:h-[20rem] min-[1200px]:max-[1300px]:h-[16rem]">
                  <ClipsVideoCard youTubeVideoID={singleClip.youTubeVideoID} />
                </div>
                ...
                <div className="flex flex-row justify-between max-md:text-[1rem]">
                  <div className="text-slate-600">
                    <CustomMdx source={singleClip.description} />
                  </div>
                </div>
              </div>
            </div>
...
export default ClipsDetailsPage;
