...
const DeleteClipPopup = ({ docID, imageFileID, refetch, type = "icon" }) => {
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle className="!text-slate-700">
            Вы уверены что хотите удалить клип?
          </AlertDialogTitle>
          <AlertDialogDescription>
            Данное действие безвозвратно удалит клип из базы данных. Вся текущая
            информация о клипе будет потеряна.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
...
export default DeleteClipPopup;
