...
const DeleteNewsPopup = ({ docID, imageFileID, refetch, type = "icon" }) => {
    ...
    <AlertDialog open={open} onOpenChange={setOpen}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Данное действие безвозвратно удалит новость из базы данных. Вся
            текущая информация о новости будет потеряна.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
