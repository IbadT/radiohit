  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {singleTrackData &&
            ...
            playing && <AudioAnimation className="z-[2]" />}
          {singleTrackData &&
            singleTrackData.trackURL == song.trackURL &&
            isAudioLoading && (
      ...
      <div className="flex flex-row justify-around max-md:hidden w-full">
        ...
        <Link href={`/songs/${song.$id}`} className="flex flex-row items-center justify-start whitespace-nowrap text-[#b2b2b2] text-gray-500 font-[400] text-[0.9rem] transition-coloros duration-300 hover:text-mainAccent min-[1200px]:max-[1400px]:text-[0.9rem] gap-[0.5rem] rounded-2xl border-[1px] px-[1rem] py-[0.3rem] hover:border-mainAccent">
...
export default ArtistTracksCard;
