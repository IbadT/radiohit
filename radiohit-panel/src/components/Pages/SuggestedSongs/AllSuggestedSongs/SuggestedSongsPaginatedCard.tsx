...
const SuggestedSongsPaginatedCard = ({ song }) => {
  const {
    setSingleTrackData,
    singleTrackData,
    stopped,
    ...
    >
      ...
      <div className="grid grid-cols-3 w-full max-md:hidden">
        <div className="flex flex-row w-full justify-start gap-[1.5rem] items-center">
          <div className="flex flex-row items-center justify-start whitespace-nowrap text-gray-500 font-[300] text-[0.9rem] transition-coloros duration-300 hover:text-mainAccent min-[1200px]:max-[1400px]:text-[0.8rem]">
        ...
        >
          <p className="text-[0.9rem]">Добавить информацию</p>
...
export default SuggestedSongsPaginatedCard;
