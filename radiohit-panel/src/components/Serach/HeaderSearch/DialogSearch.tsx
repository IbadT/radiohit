...
const DialogSearchHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn('flex flex-col space-y-1.5 text-center sm:text-left', className)} {...props} />
);
DialogSearchHeader.displayName = 'DialogHeader';

const DialogSearchFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
